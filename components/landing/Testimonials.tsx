...
export default function Testimonials() {
  const testimonials = [
    {
      quote: "Theem saved me hours of work. I was able to create a beautiful theme for my SaaS in minutes.",
      author: "Sarah K.",
      role: "Indie Hacker",
    },
    {
    ...
    {
      quote: "Being able to export to any framework is a game-changer. Works perfectly with my Next.js projects.",
      author: "Jamie L.",
      role: "Full-stack Developer",
    },
    {
      quote: "The version control feature is brilliant. I can experiment without fear of losing my work.",
      author: "Chris D.",
      role: "UI Engineer",
    },
    {
      quote: "As a non-designer, Theem has been invaluable for creating professional-looking themes.",
      author: "Pat M.",
      role: "Solo Founder",
    },
  ]
